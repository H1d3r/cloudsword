module github.com/wgpsec/cloudsword
...
require (
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/cvm v1.0.1056
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/lighthouse v1.0.1056
